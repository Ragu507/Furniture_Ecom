...
env_file = f'.env.{os.environ.get("CURRENT_ENV", "prod")}'
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 10,
    'ALLOWED_PAGE_SIZES':[5,15,20,50,100],
}
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=1),  # Shorter lifespan for access token
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),  # Longer lifespan for refresh token
}
